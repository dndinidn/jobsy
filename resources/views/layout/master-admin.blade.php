...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="assets-admin/images/ftco-32x32.png">
    
    <link rel="stylesheet" href="assets-admin/css/custom-bs.css">
    ...
    <link rel="stylesheet" href="assets-admin/fonts/line-icons/style.css">
...
@yield('konten')
    ...
    <script src="assets-admin/js/stickyfill.min.js"></script>
    <script src="assets-admin/js/jquery.fancybox.min.js"></script>
    <script src="assets-admin/js/jquery.easing.1.3.js"></script>
    
    <script src="assets-admin/js/jquery.waypoints.min.js"></script>
    <script src="assets-admin/js/jquery.animateNumber.min.js"></script>
