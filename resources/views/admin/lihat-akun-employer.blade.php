...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Daftar Akun Employer</h1>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tabel Employer</h6>
        </div>
        <div class="card-body">
            @if(session('success'))
            ...
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center">Belum ada data employer.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
